...
class APsidebarcontroller
{
	function list_sidebar()
	{
		$components = &APsidebar::load_sidebar();
		
		APsidebarhtml::list_sidebar($components);
	}
	...
	function list_search()
	{
		...
		$components = &APsidebar::loadSearchResults($keyword);
	}
}
?>