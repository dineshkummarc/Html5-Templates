...
class APhtml
{
	function list_components(&$components)
	{
			      ...
			      foreach ($components AS $i => $component)
			      {
			      	  ...
			      	  <li class="component<?php echo $k;?> parent <?php echo substr($component->img, 6);?>">
			      	     <?php if ($component->link) { $ignore_first = false; ?>
			      	        <a href="<?php echo $component->link;?>" onclick="toggle_visibility('child-list-<?php echo JText::_($component->title);?>');" class="parent-link"><?php echo JText::_($component->title);?></a>
