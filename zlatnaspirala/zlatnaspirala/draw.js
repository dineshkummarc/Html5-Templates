...
CUBE(2,5,11,zlatnaspirala);
BLADEROTATE(2,6,11,greenmatrix1,2);
BLADEROTATEDEGX(2,4,11,greenmatrix1,180);
...
BLADEROTATEDEGX(-2,4,10,greenmatrix1,180);
		...
		PILEZ(-6,-2,90,greenglass);
		PILEZ(-8.5,-2,90,greenglass);
		//BLADEMID(-90,0,30,floor);
